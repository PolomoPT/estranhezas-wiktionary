...
output_file_path = 'Hífen\\com_mal.txt'
...
with open(input_file_path, 'r', encoding='utf-8') as input_file, open(output_file_path, 'w', encoding='utf-8') as output_file:
    for line in input_file:
        ...
        if not match_connectivo and not match_prefixo_a and not match_prefixo_e and not match_prefixo_i or match_prefixo_o and not match_in_des and not match_m_n and not match_b and not match_co_re:
            if match_mal:
