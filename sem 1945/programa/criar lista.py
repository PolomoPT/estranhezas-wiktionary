...
with open(input_file_path, 'r', encoding='utf-8') as input_file, open(ü_file_path, 'w', encoding='utf-8') as output_file:
    for line in input_file:
        match_ì_ù = re.search('(a|â|á|à|e|ê|é|è|i|í|ì|ï|o|ô|ó|ò|u|ú|ù|ü)(ï|ü)', line) #antecedido por vogal
        match_ù = re.search('(q|g)ü(e|ê|é|è|i|í|ì|ï)', line) #antecedido por <q> <g>
